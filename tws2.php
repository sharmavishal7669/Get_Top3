...
<br>
  ...
  <div class="d-flex flex-sm-column flex-md-row justify-content-around">
    ...
    <div class="bg-info flex-md-fill p-2 m-3 text-center overflow-hidden">
      ...
      <div class="bg-dark shadow-sm mx-auto" style="width: 80%; height: 200px; border-radius: 21px 21px 0 0;"><img style="width: 100%; height: inherit;border-radius:inherit;" src="imgs/apple.jpg" alt="Apple airpods"></div>
    ...
    <div class="bg-info flex-md-fill p-2 text-center overflow-hidden">
      ...
      <div class="bg-dark shadow-sm mx-auto" style="width: 80%; height: 200px; border-radius: 21px 21px 0 0;"><img style="width: 100%; height: inherit;border-radius:inherit;" src="imgs/samsung-galaxy-buds-plus-9.jpg" alt="Samsung Galaxy Buds+"></div>
    ...
    <div class="bg-info flex-md-fill p-2 m-3 text-center overflow-hidden">
      ...
      <div class="bg-dark shadow-sm mx-auto" style="width: 80%; height: 200px; border-radius: 21px 21px 0 0;"><img style="width: 100%; height: inherit;border-radius:inherit;" src="imgs/cwelch_200114_3847_0001.jpg" alt="Jabra elite 75t"></div>
